  ...
  return (
    ...
    <Grid container row='true' sx={{display:'flex',justifyContent:'center'}}>
        ...
        <Grid  md={10} xs={11} item className='zikirlerim_zikir_1'> {/* zikir1 */}
            <Grid container>
                <Grid sx='auto' p={'1%'}>
                <Typography variant='h5'>Zikir Adı</Typography>
                </Grid>
                <Grid sx='auto' p={'1%'}>
                <Typography variant='h5'> “İslâm, güzel ahlâktır.” (Kenzü’l-Ummâl, 3/17, HadisNo: 5225.)</Typography>
                </Grid>
            </Grid>
            <Grid md={4} sm={6} xs={11} p={'1%'}>
            <div className='zikir_skor_ve_butonlar'>
                <Typography variant='h5'>Son Zikir:500</Typography>
                <div>
               <button className='buton_devamet'>Devat Et</button>
               <button className='buton_sil'>Sil</button>
               </div>
            </div></Grid>
        </Grid>
        ...
        <Grid  md={10} xs={11} item className='zikirlerim_zikir_1'> {/* zikir 2 */}
            <Grid container>
                ...
                <Grid sx='auto' p={'1%'}>
                <Typography variant='h5'>  “İnsanların Peygamberlerden öğrenegeldikleri sözlerden biri de: ‘Utanmadıktan sonra dilediğini yap!’ sözüdür.” (Buhârî, Enbiyâ, 54; EbuDâvûd, Edeb, 6.)</Typography>
                </Grid>
            </Grid>
            <Grid md={4} sm={6} xs={11} p={'1%'}>
            <div className='zikir_skor_ve_butonlar'>
